...
let handler = async(m, { conn, text }) => {
    ...
    conn.sendMessage('6288287677384@s.whatsapp.net', teks1, MessageType.text)
    conn.reply(m.chat, '✔️Masalah telah di laporkan ke Developer BOT, laporan palsu/main2 tidak akan ditanggapi.', m)
}
